...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="mb-4">
        <a href="movie_add.php" class="bg-yellow-500 text-black px-4 py-2 rounded font-bold hover:bg-yellow-600">+ Add new movie</a>
    </div>
                ...
                <?php foreach ($movies as $m): ?>
                    <tr class="border-b border-gray-800 hover:bg-gray-800">
                        ...
                        <td class="px-4 py-3 flex gap-2">
                            <a href="movie_edit.php?id=<?= $m['movie_id'] ?>" class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-sm">Edit</a>
                            <a href="movie_delete.php?id=<?= $m['movie_id'] ?>" class="bg-red-600 hover:bg-red-700 px-3 py-1 rounded text-sm" onclick="return confirm('Delete this movie?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
