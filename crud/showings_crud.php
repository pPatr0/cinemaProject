...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="mb-4">
        <a href="showing_add.php" class="bg-yellow-500 text-black px-4 py-2 rounded font-bold hover:bg-yellow-600">+ Add new showing</a>
    </div>
                    ...
                    <?php foreach ($showings as $s): ?>
                        <tr class="border-b border-gray-800 hover:bg-gray-800">
                            ...
                            <td class="px-4 py-3 flex gap-2">
                                <a href="showing_edit.php?id=<?= $s['showing_id'] ?>" class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-sm">Edit</a>
                                <a href="showing_delete.php?id=<?= $s['showing_id'] ?>" class="bg-red-600 hover:bg-red-700 px-3 py-1 rounded text-sm" onclick="return confirm('Delete this showing?')">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
