...
<body class="bg-black text-white">
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="company_info.php" class="block bg-gray-900 rounded-lg border border-gray-800 hover:border-yellow-500 transition p-6">
                <h2 class="text-xl font-bold mb-2">Company Info</h2>
                <p class="text-gray-400 text-sm">Edit description, opening hours & contact.</p>
            </a>

            <a href="movies_crud.php" class="block bg-gray-900 rounded-lg border border-gray-800 hover:border-yellow-500 transition p-6">
                <h2 class="text-xl font-bold mb-2">Movies</h2>
                <p class="text-gray-400 text-sm">Add, edit or delete movies.</p>
            </a>

            <a href="showings_crud.php" class="block bg-gray-900 rounded-lg border border-gray-800 hover:border-yellow-500 transition p-6">
                <h2 class="text-xl font-bold mb-2">Showings</h2>
                <p class="text-gray-400 text-sm">Manage daily screenings.</p>
            </a>

            <a href="hero_showing.php" class="block bg-gray-900 rounded-lg border border-gray-800 hover:border-yellow-500 transition p-6">
            ...
            <a href="news_crud.php" class="block bg-gray-900 rounded-lg border border-gray-800 hover:border-yellow-500 transition p-6">
                <h2 class="text-xl font-bold mb-2">News</h2>
                <p class="text-gray-400 text-sm">Publish or edit news articles.</p>
            </a>

            <a href="../index.php" class="block bg-yellow-500 text-black rounded-lg p-6 hover:bg-yellow-600 transition">
